        ...
        <section className='py-8'>
            <div className='container'>
                <div className='flex flex-wrap justify-between gap-4'>
                    ...
                    <div className='w-full md:w-[32%] px-10 py-10 md:px-12 md:py-14 rounded-lg' style={setBackgroundImage('https://demo4.drfuri.com/farmart2/wp-content/uploads/sites/11/2021/05/homepage-new-banner-3.png', { backgroundPosition: 'bottom', backgroundColor: '#D5DEE5', backgroundSize: 'unset' })}>
                        <div className='flex flex-col justify-between'>
                    ...
                    <div className='w-full md:w-[32%] px-10 py-10 md:px-12 md:py-14 rounded-lg' style={setBackgroundImage('https://demo4.drfuri.com/farmart2/wp-content/uploads/sites/11/2021/05/homepage-new-banner-4.png', { backgroundPosition: 'center center', backgroundColor: '#FEAC7D', backgroundSize: 'cover' })}>
                        <div className='flex flex-col justify-between'>
                            <div className="">

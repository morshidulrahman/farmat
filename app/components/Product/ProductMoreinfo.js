        ...
        <div className="py-12 bg-[#F5F5F5]">
            <div className="container">
                <Tabs color="yellow" orientation="vertical" defaultValue="Descrition">
                    <Tabs.List>
                        <Tabs.Tab value="Descrition" icon={<BiDetail size={14} />}>Description</Tabs.Tab>
                        <Tabs.Tab value="Additional" icon={<BiInfoCircle size={14} />}>Additional Information</Tabs.Tab>
                        <Tabs.Tab value="Review" icon={<BiStar size={14} />}>Description</Tabs.Tab>
                    </Tabs.List>
